...
from model.videogpt_plus.model.internvideo.config import Config, eval_dict_leaf
from model.videogpt_plus.model.internvideo.utils import setup_internvideo2V


def build_internvideo(model_path):
    config = Config.from_file('model/videogpt_plus/model/internvideo/internvideo2_stage2_config_vision.py')
